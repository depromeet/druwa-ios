...
public class StarRateView: UIView {
    ...
    lazy var starSpace:CGFloat = 0.0
    ...
    public override convenience init(frame: CGRect) {
        ...
        self.init(frame:frame, totalStarCount:5.0, currentStarCount:0.0, starSpace:0.0)
    }
    ...
    public init(frame:CGRect, totalStarCount:CGFloat, currentStarCount:CGFloat, starSpace:CGFloat) {
        ...
        unStarView = setupStarView("iconStarNone")
        
        addSubview(unStarView)
        
        starView = setupStarView("iconStarOn")
